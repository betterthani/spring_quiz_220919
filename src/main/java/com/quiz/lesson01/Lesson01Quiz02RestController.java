...
public class Lesson01Quiz02RestController {
	...
	public List<Map<String, Object>> list () {
		...
		// @ResponseBody + 객체 리턴 => HttpMessagetConverter 객체 내용을 jackson 라이브러리 => JSON 응답 - API
	...
	public List<Info> quiz02_2(){
		...
		board.setTitle("헐 대박");
		board.setUser("bada");
		board.setContent("오늘 목요일이 있어... 금요일인줄");
		result.add(board);
		...
		return result; // jackson 라이브러리에 의해 JSON 변환
	...
	@RequestMapping("/3")
	public ResponseEntity<Info> quiz02_3(){
		Info info = new Info();
		info.setTitle("안녕하세요 가입인사 드립니다.");
		info.setUser("hagulu");
		info.setContent("안녕하세요 가입했어요. 앞으로 잘 부탁드립니다. 활동 열심히 하겠습니다.");
